...
public class ConnectionPropsTest extends GenericDbBase
{
    ...
    public void setUp() throws Exception
    {
        ...
        node1 = nodeFactory.create(nodeName1, Node.Type.SATELLITE, null);
        node2 = nodeFactory.create(nodeName2, Node.Type.SATELLITE, null);
        ...
        res1 = resourceFactory.create(resDfn, node1, payload1, null, Collections.emptyList());
        res2 = resourceFactory.create(resDfn, node2, payload2, null, Collections.emptyList());
        ...
        nodeCon = nodeConnectionFactory.create(node1, node2);
        resCon = resourceConnectionFactory.create(res1, res2, null);
        volCon = volumeConnectionFactory.create(vol1, vol2);

        nodeConProps = nodeCon.getProps();
        resConProps = resCon.getProps();
        volConProps = volCon.getProps();

        conProps = new PriorityProps(nodeCon, resCon, volCon);
    }

    @SuppressWarnings("checkstyle:variabledeclarationusagedistance")
    @Test
    public void test() throws InvalidKeyException, InvalidValueException, DatabaseException
    {
